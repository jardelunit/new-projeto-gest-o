...
export const mockFreights: Freight[] = [
  { id: 'f1', origin: 'São Paulo, SP', destination: 'Curitiba, PR', value: 3500, status: 'Em Progresso', date: '2023-12-01', vehicleId: 'v1', driverId: 'd1' },
  { id: 'f2', origin: 'Belo Horizonte, MG', destination: 'Rio de Janeiro, RJ', value: 2800, status: 'Entregue', date: '2023-11-28', vehicleId: 'v2', driverId: 'd2' },
  { id: 'f3', origin: 'Porto Alegre, RS', destination: 'Florianópolis, SC', value: 1500, status: 'Pendente', date: '2023-12-05', driverId: 'd4' },
  { id: 'f4', origin: 'Cuiabá, MT', destination: 'Santos, SP', value: 8900, status: 'Em Progresso', date: '2023-12-02', vehicleId: 'v5', driverId: 'd4' },
  { id: 'f5', origin: 'Recife, PE', destination: 'Salvador, BA', value: 4200, status: 'Cancelado', date: '2023-11-25', driverId: 'd2' },
];
